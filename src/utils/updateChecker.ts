...
export const RELEASES_REPO = 'rajwalgautam/heart-rate-monitor';
...
const STORAGE_KEYS = {
  lastChecked: '@heartratemonitor/last_update_check_at',
  lastNotified: '@heartratemonitor/last_notified_version',
  pendingApk: '@heartratemonitor/pending_apk_path',
} as const;
...
export async function downloadAndInstallApk(version: string): Promise<void> {
